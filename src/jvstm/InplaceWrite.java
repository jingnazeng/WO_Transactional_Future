...
public class InplaceWrite<T> {
    ...
    private static class Offsets {
        ...
        //added
        private static final long nextOffset = UtilUnsafe.objectFieldOffset(InplaceWrite.class, "next");
    ...
    //added
    protected boolean CASnext(InplaceWrite<T> prevNext, InplaceWrite<T> newNext) {
        return UNSAFE.compareAndSwapObject(this, Offsets.nextOffset, prevNext, newNext);
    }
