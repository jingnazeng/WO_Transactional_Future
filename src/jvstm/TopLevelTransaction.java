...
public class TopLevelTransaction extends ReadWriteTransaction {
    ...
    public void initialDAG(){
    	dagPerToplevelTxn = new DAG();
    	Node node = dagPerToplevelTxn.startTxn(this);
    	this.setAssociatedNode(node);
    	
    }
    
    public DAG getDAG(){
    	if(dagPerToplevelTxn == null){
    		initialDAG();
    	}
    	return dagPerToplevelTxn;
    }   
     ...
     *
     * // * If validation succeeds the transaction is upgraded to the latest
