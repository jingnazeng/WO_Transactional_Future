...
public class PatternTxn6By16Futures extends ArrayAccessWriteTxnWithMultipleFutures{
	VBox<Integer>[] array;
	private int value;
	...
	public PatternTxn6By16Futures(int max_num_of_core, int prefix_disjoint_read, int hot_spot_in_the_array,int num_of_hot_spots_read_and_write, String high_contention, int spin){
	...
	public int executeTransaction(Transaction tx, int sibling, int streaming) throws Throwable {
		...
		for(int i = 1; i <= max_num_of_core/num_of_futures ; i++){
			...
			FutureRepresentation<Integer> f9;
			FutureRepresentation<Integer> f10;
			FutureRepresentation<Integer> f11;
			FutureRepresentation<Integer> f12;
			FutureRepresentation<Integer> f13;
			FutureRepresentation<Integer> f14;
			FutureRepresentation<Integer> f15;
			FutureRepresentation<Integer> f16;
			while(true){
				try{
					//T2 logic
					...
					while(true){
						try{
								...
								try{
									...
									while(true){
										try{
												...
												try{
													...
													while(true){
														try{
																...
																try{
																	...
																	while(true){
																		try{
																			//T9 logic
																			readHotSpots(number_of_hot_spots_read_and_write);
																			f9  = ((ReadWriteTransaction)Transaction.current()).
																					submitWeakOrderingFuture(new WeakFutureTask(new AsychOpsFuture1()));
																			while(true){
																				try{
																					//T10 logic
																					readHotSpots(number_of_hot_spots_read_and_write);
																					f10  = ((ReadWriteTransaction)Transaction.current()).
																							submitWeakOrderingFuture(new WeakFutureTask(new AsychOpsFuture1()));
																					while(true){
																						try{
																							//T11 logic
																							readHotSpots(number_of_hot_spots_read_and_write);
																							f11  = ((ReadWriteTransaction)Transaction.current()).
																									submitWeakOrderingFuture(new WeakFutureTask(new AsychOpsFuture1()));
																							while(true){
																								try{
																									//T12 logic
																									readHotSpots(number_of_hot_spots_read_and_write);
																									f12  = ((ReadWriteTransaction)Transaction.current()).
																											submitWeakOrderingFuture(new WeakFutureTask(new AsychOpsFuture1()));
																									while(true){
																										try{
																											//T13 logic
																											readHotSpots(number_of_hot_spots_read_and_write);
																											f13  = ((ReadWriteTransaction)Transaction.current()).
																													submitWeakOrderingFuture(new WeakFutureTask(new AsychOpsFuture1()));
																											while(true){
																												try{
																													//T14 logic
																													readHotSpots(number_of_hot_spots_read_and_write);
																													f14  = ((ReadWriteTransaction)Transaction.current()).
																															submitWeakOrderingFuture(new WeakFutureTask(new AsychOpsFuture1()));
																													while(true){
																														try{
																															//T15 logic
																															readHotSpots(number_of_hot_spots_read_and_write);
																															f15  = ((ReadWriteTransaction)Transaction.current()).
																																	submitWeakOrderingFuture(new WeakFutureTask(new AsychOpsFuture1()));
																															while(true){
																																try{
																																	//T16 logic
																																	readHotSpots(number_of_hot_spots_read_and_write);
																																	f16  = ((ReadWriteTransaction)Transaction.current()).
																																			submitWeakOrderingFuture(new WeakFutureTask(new AsychOpsFuture1()));
																																	while(true){
																																		try{
																																			//T17 logic
																																			...
																																			if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																																				...
																																				e.printStackTrace();
																																				System.out.println("T17 restarting");
																																			}
																																		}
																																	}
																																	...
																																	if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																																		...
																																		e.printStackTrace();
																																		System.out.println("T16 restarting");
																																	}
																																}
																															}
																															...
																															if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																																...
																																e.printStackTrace();
																																System.out.println("T15 restarting");
																															}
																														}
																													}
																													...
																													if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																														...
																														e.printStackTrace();
																														System.out.println("T14 restarting");
																													}
																												}
																											}
																											...
																											if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																												...
																												e.printStackTrace();
																												System.out.println("T13 restarting");
																											}
																										}
																									}
																									...
																									if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																										...
																										e.printStackTrace();
																										System.out.println("T12 restarting");
																									}
																								}
																							}
																							...
																							if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																								...
																								e.printStackTrace();
																								System.out.println("T11 restarting");
																							}
																						}
																					}
																					...
																					if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																						...
																						e.printStackTrace();
																						System.out.println("T10 restarting");
																					}
																				}
																			}
																			value += (Integer) Transaction.current().evalWeakOrderingFuture(f9);
																			break;
																		}catch(Throwable e){
																			if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																				throw e;
																	...
																	value += (Integer) Transaction.current().evalWeakOrderingFuture(f10);
																	break;
																}catch(Throwable e){
																	if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																		throw e;
															...
															value += (Integer) Transaction.current().evalWeakOrderingFuture(f11);
															break;
														}catch(Throwable e){
															if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
																throw e;
													...
													value += (Integer) Transaction.current().evalWeakOrderingFuture(f12);
													break;
												}catch(Throwable e){
													if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
														throw e;
											...
											value += (Integer) Transaction.current().evalWeakOrderingFuture(f13);
											break;
										}catch(Throwable e){
											if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
												throw e;
									...
									value += (Integer) Transaction.current().evalWeakOrderingFuture(f14);
									break;
								}catch(Throwable e){
									if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
										throw e;
							...
							value += (Integer) Transaction.current().evalWeakOrderingFuture(f15);
							break;
						}catch(Throwable e){
							if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
								throw e;
					...
					value += (Integer) Transaction.current().evalWeakOrderingFuture(f16);
					break;
				}catch(Throwable e){
					if(e.getCause() instanceof EarlyAbortException || e instanceof EarlyAbortException)
						throw e;
